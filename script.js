...
const account3 = {
  owner: 'Copter Paramet',
  movements: [500, 600, 800, 1000, -2000, 1000, 500, -3000],
  interestRate: 1.2, // %
  pin: 3333,
...
const calcDisplayBalance = function (acc) {
  ...
  const formatMov = formatCurr(acc.balance, acc.locale, acc.currency);
...
console.log(1564858848974946979749749n * 10000000000000000n);
const huge = 548465478465n;
const num = 253;
...
const now = new Date();
console.log(now);
console.log(new Date(' Aug 01 2021 15:54:09'));
...
const days1 = CalDate(new Date(2037, 3, 14), new Date(2037, 3, 4));

console.log(days1);
*/
/*
const nun = 388845484.23;
const options = {
  style: 'currency',
  unit: 'celsius',
  currency: 'EUR',
...
console.log('Geramany:', new Intl.NumberFormat('de-DE', options).format(nun));
console.log('Syria:', new Intl.NumberFormat('ar-SY', options).format(nun));
console.log('Thailand:', new Intl.NumberFormat('th-TH', options).format(nun));
console.log(
  navigator.language,
  new Intl.NumberFormat(navigator.language, options).format(nun)
);
*/
